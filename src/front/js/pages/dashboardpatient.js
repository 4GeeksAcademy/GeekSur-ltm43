...
export const DashboardPatient = () => {
    ...
    const patientLocation = `${patient?.city || "San Francisco"}, ${patient?.country || "CA"}`;
                ...
                <div className="d-flex" style={{ minHeight: "100vh", backgroundColor: "#b7f4ff" }}>
                    ...
                    <div className="d-flex flex-column flex-shrink-0 p-3 text-white" style={{ width: "280px", backgroundColor: "rgb(100, 191, 208)" }}>
                        ...
                        <ul className="nav nav-pills flex-column mb-auto">
                            ...
                            <li>
                                <Link to="/panelpatient" className="nav-link text-white" onClick={() => console.log("Navegando a /panelpatient")}>
                    ...
                    <div className="flex-grow-1 p-4" style={{ backgroundColor: "#b7f4ff", color: "#000" }}>
                        ...
                        <div className="row g-4">
                                ...
                                <div className="card" style={{ backgroundColor: "#f8f9fa", border: "none" }}>
                                    <div className="card-body">
                                        <div className="d-flex align-items-center mb-3">
                                            ...
                                            <h5 className="card-title mb-0" style={{ color: "#000" }}>Mis Citas</h5>
                                        </div>
                                ...
                                <div className="card" style={{ backgroundColor: "#f8f9fa", border: "none" }}>
                                    <div className="card-body">
                                        <div className="d-flex align-items-center mb-3">
                                            ...
                                            <h5 className="card-title mb-0" style={{ color: "#000" }}>Consultar con IA</h5>
                                        </div>
                                        <h3 className="card-text" style={{ color: "#000" }}>Disponible</h3>
                            ...
                            <div className="mt-4 text-center">
                                <Link to="/ai-consultation" className="btn" style={{ backgroundColor: "#97dbe7", color: "#000" }}>
